...
export const button = tv(
  {
    ...
    variants: {
      ...
      design: {
        ...
        filled_light:
          'bg-greyscale-light-2 text-greyscale-dark-1 hover:bg-pink hover:text-greyscale-white',
        filled_dark:
          'bg-greyscale-dark-2 text-greyscale-white hover:bg-dark-pink hover:text-pink',
        filled_pink:
          'bg-pink text-greyscale-white hover:bg-dark-pink hover:text-pink',
        neutral_dark:
          'text-greyscale-dark-2 hover:bg-greyscale-light-2 hover:text-greyscale-dark-1',
        neutral_light:
          'text-greyscale-light-2 hover:bg-greyscale-light-2 hover:text-greyscale-dark-1',
      },
      disabled: {
